<?php
  ...
  while($row = $result->fetch_assoc()) {
    ...
    if ($row['id'] == $id) {
      ...
      echo "<td>" . $row['date'] . "</td>";
      echo '<td><a class="btn btn-primary" href="resevation.php?id=' . $row['id'] . '" role="button">Update</a></td>';
      echo '<td><a class="btn btn-primary" href="delete.php?id=' . $row['id'] . '" role="button">delete</a></td>';
      echo "</tr>";
    }
